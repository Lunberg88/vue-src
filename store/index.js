...
const store = new Vuex.Store({
    ...
    mutations: {
        ...
        changeStatusIsLoading(state) {
            state.globalIsLoading = !state.globalIsLoading
        },
        /*
    ...
    actions: {
        globalIsLoading({commit}) {
            commit('changeStatusIsLoading')
        },
        setUser({commit}, data) {
        ...
        async setTest({commit}) {
            ...
            await axios.get('http://ajax-lv/api/user', headers)
                .then(response => {
